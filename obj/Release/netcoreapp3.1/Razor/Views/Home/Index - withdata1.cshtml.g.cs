#pragma checksum "D:\GitCHATBOT-Landboat\chatbot\Views\Home\Index - withdata1.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b42714d3510d2f6178d3f1d163ceb028e5ca2733"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_Index___withdata1), @"mvc.1.0.view", @"/Views/Home/Index - withdata1.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b42714d3510d2f6178d3f1d163ceb028e5ca2733", @"/Views/Home/Index - withdata1.cshtml")]
    ...
    public class Views_Home_Index___withdata1 : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #line hidden
        ...
        {
#nullable restore
#line 1 "D:\GitCHATBOT-Landboat\chatbot\Views\Home\Index - withdata1.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b42714d3510d2f6178d3f1d163ceb028e5ca27333444", async() => {
                WriteLiteral(@"
    <meta charset=""UTF-8"">
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b42714d3510d2f6178d3f1d163ceb028e5ca27334881", async() => {
...
#nullable restore
#line 32 "D:\GitCHATBOT-Landboat\chatbot\Views\Home\Index - withdata1.cshtml"
...
#nullable disable
    ...
    <script type=""text/javascript"">
        ...
        function LoadCardOptionQuestion(data) {
            ...
            htmtxt += '<svg class=""MessageBubbl");
                WriteLiteral(@"e__Decorator"" xmlns=""http://www.w3.org/2000/svg"" width=""16"" height=""28""';
            ...
            if (data.cards[0].items.length > 0) {
                ...
                htmtxt += '<div ");
                WriteLiteral(@"class=""option_Msg_content"">';
            ...
            setTimeout(function () {
                ...
                $('.back_btn').removeClass('show');
                $('#mainsection').a");
                WriteLiteral(@"ppend(htmtxt).fadeIn().slideDown(1000);
                ScrollDown();
            }, 1000)
        }
        ...
        function LoadQuestion(data) {
            ...
            if (data.input.length > 0) {
                ...
                if (data.input[0].format==""auto"")
                    ...
                    htmtxt += '<input type=""text"" class=""input is-an");
                WriteLiteral(@"imate-messages-on inputdata"" data-max=""' + data.input[0].max + '"" data-min=""' + data.input[0].min + '"" />';
                ...
                htmtxt += '<g class=""ldl-ani""';
       ");
                WriteLiteral(@"         htmtxt += 'style=""transform-origin: 50px 50px 0px; animation: 1.11111s linear -1.11111s infinite normal forwards running static-75f7fad1-5fd4-4122-8a31-76b7e68e98b2;"">';
                ...
                htmtxt += 'd=""M53.4 68.511l.6 3.906a4.0");
                WriteLiteral(@"48 4.048 0 0 1-8 1.23 4.183 4.183 0 0 1 0-1.229l.6-3.906a3.44 3.44 0 0 1 6.8-.001z""';
                ...
                htmtxt += '</d:tags><d:license>by</d:license><d:slug>oiotst</d:slug></metadata></g></g></svg></");
            ...
            htmtxt += '<div class=""back_btn_container"">';
            htmtxt += '<button type=""button"" data-parentid=""' ");
                WriteLiteral(@"+ data.parentid + '"" onclick=""loadBackquestion(this);"" class=""back_btn"">Back</button>';
            htmtxt += '</div>';
            htmtxt += '</article>';
            setTimeout(function () {
                $('.typeLoader').fadeOut();
        ...
        function LoadUserSentMessage(message) {
            ...
            htmtxt += '</article>';
            setTimeout(function () {
                $('#mainsection').append(htmtxt).fadeIn");
                WriteLiteral(@"().slideDown(500);
                ScrollDown();
            }, 500)
      ...
      ");
                ...
                case 'spo2applicable':
    ");
                WriteLiteral(@"                spo2applicable = qtext
                    break;
                case 'spo2rate':
                    spo2rate = qtext
                    break;
...
");
        ...
        function AskNextQuestionInput(objthis) {
            var cQid = $(objthis).attr('data-var');
            var dataobj = $(objthis).attr('data-obj');
            var qtext = $(objthis).parent().fi");
                WriteLiteral(@"nd('.inputdata').val();
            var curentqid = $(objthis).attr('data-curentqid');
            var data = GetQuestionById(JData, cQid);
            var currentQuestion = GetQuestionById(JData, curentqid);
            switch (dataobj) {
        ...
        function AskNextQuestionCardOption(objthis) {
            ...
            var dataobj = $(objthis).attr('data-obj');
            var cQid = $(objthis).attr('d");
                WriteLiteral(@"ata-var');
            var qtext = '';
        ...
        function LoadWellcomeMessage() {
            ");
                WriteLiteral(@"var data = GetQuestionById(JData, 1);
            LoadQuestion(data);
        }
        ...
        $(document).on");
                WriteLiteral(@"('mouseleave', 'article', function () {
            $('.back_btn').removeClass('show');
        });
        ...
        function PrintChat(txtMsg) {
            ...
            htmtxt += '<desc> Created with Sketch.</desc>';
            h");
                WriteLiteral(@"tmtxt += '<g fill=""none"">';
            htmtxt += '<path d=""M5 0.2C5 10 5 16.6 5 20 5 23.4 3.3 25.8 0 27.2 10.5 27.8 15.8 24.8 15.8 18.4 15.8 16.3 15.8 10.3 15.8 0.2L5 0.2Z""';
            htmtxt += 'fill=""#FFF""></path>';
            htmtxt += '</g>';
            htmtxt += '</svg>';
        ...
        function PrintVariable1() {
            if (covi");
                WriteLiteral(@"dtest == 'Yes' || covidantigentest == 'Positive' || contactwithcovid == 'Yes') {
                if (feversince > 2) {
        ...
        function AddLog(Answer, Question, DataVariableName, DataVariableValue) {
            var sData = {
                ...
                DataVariableValue: DataVariab");
                WriteLiteral(@"leValue,
                UserToken: $('#chid').val()
            };
