#pragma checksum "D:\Parmod\ChatBoot\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0e23562aeb7ff8dc2d8066e3da53aa999be59e2c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0e23562aeb7ff8dc2d8066e3da53aa999be59e2c", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\Parmod\ChatBoot\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0e23562aeb7ff8dc2d8066e3da53aa999be59e2c3324", async() => {
                WriteLiteral(@"
    <meta charset=""UTF-8"">
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0e23562aeb7ff8dc2d8066e3da53aa999be59e2c4683", async() => {
                ...
                BeginWriteAttribute("value", " value=\"", 881, "\"", 900, 1);
#nullable restore
#line 27 "D:\Parmod\ChatBoot\Views\Home\Index.cshtml"
WriteAttributeValue("", 889, ViewBag.ID, 889, 11, false);
...
#nullable disable
    ...
    <script type=""text/javascript"">
        ...
        function LoadCardOptionQuestion(data) {
            ...
            htmtxt += '<svg class=""MessageBubble");
                WriteLiteral(@"__Decorator"" xmlns=""http://www.w3.org/2000/svg"" width=""16"" height=""28""';
            ...
            if (data.cards[0].items.length > 0) {
                ...
                htmtxt += '<div c");
                WriteLiteral(@"lass=""option_Msg_content"">';
                for (var i = 0; i < cardItem.length; i++) {
                    htmtxt += '<div class=""option_Msg_item"">' + cardItem[i].name + '</div>';
                }
                htmtxt += '</div>';
                htmtxt += '<div class=""btn_container""><div class=""btn"" data-obj=""' + data.objname + '""  data-curentqid=""' + data.id + '""  data-var=""' + data.cards[0].click + '"" onclick=""AskNextQuestionCardOption(this);"">Send</div></div>';
                htmtxt += '</div>';
            }
            htmtxt += '<div class=""back_btn_container"">';
            htmtxt += '<button type=""button"" class=""back_btn"">Back</button>';
            htmtxt += '</div>';
            htmtxt += '</article>';
            setTimeout(function () {
                $('.typeLoader').fadeOut();
     ...
     ");
                WriteLiteral(@"   function LoadQuestion(data) {
            $('.typeLoader').fadeIn();
            $('.back_btn').removeClass('show');
            var htmtxt = '';
            ...
            htmtxt += '<g fill=""none"">';
            htmtxt += '<path d=");
                WriteLiteral(@"""M5 0.2C5 10 5 16.6 5 20 5 23.4 3.3 25.8 0 27.2 10.5 27.8 15.8 24.8 15.8 18.4 15.8 16.3 15.8 10.3 15.8 0.2L5 0.2Z""';
            ...
            if (data.input.length > 0) {
                ...
                htmtxt += '<button type=""button"" class=""icon_btn btn_age_send"" data-obj=""' + data.objname + '"" data-curentqid=""' + data.id + '"" data-var=""' + data.input[0].click + '"" onclick=""AskNextQuestionInput(this);"">';
                htmtxt += '<svg ");
                WriteLiteral(@"xmlns=""http://www.w3.org/2000/svg"" width=""24"" height=""24"" x=""3650""y=""3688"">';
                ...
                htmtxt += 'x1=""36.618"" gradientUnits=""user");
                WriteLiteral(@"SpaceOnUse""';
                htmtxt += 'id=""SVGID_1_"">';
                ...
                htmtxt += 'd=""M44.859 16.397L9.485 77.667c-2.285 3.957.571 8.90");
                WriteLiteral(@"4 5.141 8.904h70.748c4.57 0 7.425-4.947 5.141-8.904l-35.374-61.27c-2.285-3.957-7.997-3.957-10.282 0z""';
                ...
                htmtxt += 'style=""transform-origin: 50px 50px 0px; animation: 1.11111s linear -1.11111s infinite normal ");
                WriteLiteral(@"forwards running static-75f7fad1-5fd4-4122-8a31-76b7e68e98b2;"">';
                htmtxt += '<path fill=""#fff""';
            ...
            ");
                WriteLiteral(@"    htmtxt += '<div class=""btn_group"">';
                for (var i = 0; i < data.buttons.length; i++) {
                    htmtxt += '<button onclick=""AskmultibuttonQuestion(this);"" class=""btn"" data-obj=""' + data.objname + '"" data-curentqid=""' + data.id + '"" data-text=""' + data.buttons[i].text + '"" data-var=""' + data.buttons[i].click + '"">' + data.buttons[i].text + '</button>';
                }
                htmtxt += '</div>';
            }
      ...
      ");
                WriteLiteral(@"      var formatted = now.getHours() + "":"" + now.getMinutes();
   ...
   ");
        ...
        function AskNextQuestion(objthis) {
            ...
            ");
                ...
                case 'crt':
                    ...
                    break;
                case 'no");
                WriteLiteral(@"iseduringbreathing':
        ...
        function AskmultibuttonQuestion(objthis) {
            ...
            switch (dataobj) {
                ...
                case 'spo2applicable':
                    s");
                WriteLiteral(@"po2applicable = qtext
                    break;
                case 'spo2rate':
                    spo2rate = qtext
                    break;
        ...
        function AskNextQuestionInput(objthis) {
            var cQid = $(objthis).attr('data-var');
  ");
                WriteLiteral(@"          var dataobj = $(objthis).attr('data-obj');
            ...
            switch (dataobj) {
                ...
                case 'covidantigentest':
                    ...
                    break;
                case ");
                WriteLiteral(@"'lookforassociated':
                    lookforassociated = qtext
                    break;
                case 'historycondition':
                    historycondition = qtext
        ...
        function AskNextQuestionCardOption(objthis) {
            ...
            switch (dataobj) {
                ...
                case 'contactwithcovid':
                    conta");
                WriteLiteral(@"ctwithcovid = qtext
                    break;
                case 'feversince':
                    feversince = qtext
                    break;
            ...
            if (condition.length > 0) {
                for (var i = 0; i < condition.length; i++) {
                    switch (condition[i].opp) {
                        case '>':
                            break;
                        case 'contains':

                            if (qtext.indexOf(condition[i].val) !== -1) {
                                ne");
                WriteLiteral(@"xtQuestionId = condition[i].true;
            ...
            //    data = GetQuestionById(JData, 6);
            //}
            //else {
            //    data = GetQuestionById(JData, 7);
            //}
            LoadUserSentMessage(qtext);
         //   $(objthis).parent().parent().find('.msg_footer').hide();
            $(objthis).parent().paren");
                WriteLiteral(@"t().hide();
            if (data.cards.length > 0) {
                LoadCardOptionQuestion(data);
            }
      ...
      ");
                WriteLiteral(@"      $('.typeLoader').fadeIn();
            var htmtxt = '';
            htmtxt += '<article class=""left-msg message"">';
            htmtxt += '<div class=""msg_container"">';
            htmtxt += '<div class="""">';
            ...
            htmtxt += '<desc> Created with Sketch.</desc>';
            htmtxt += '<g fill=""none"">';
            htmtxt += '<path d=""M5 0.2C5 10 5 16.6 5 20 5 23.4 3.3 25.8 0 27.2 10.5 27.8 15.8 24.8 15.8 18.4 15.8 16.3 1");
                WriteLiteral(@"5.8 10.3 15.8 0.2L5 0.2Z""';
            htmtxt += 'fill=""#FFF""></path>';
            htmtxt += '</g>';
            htmtxt += '</svg>';
            htmtxt += '<div class=""MessageBubble__content"">';
        ...
        function PrintVariable1() {
            if (covidtest == 'Yes' || covidantigentest == 'Positive' || contactwithcovid == 'Yes') {
                if (feversince > 2) {
                ");
                WriteLiteral(@"    if (symtoms.indexOf('Diarrhoea') !== -1 && qtext.indexOf('Vomiting') !== -1) {
           ...
           // PrintFinalAnswer('Hello User');
            //alert(""age:"" + age);
            //alert(""weight:"" + weight);
            //alert(""symtoms:"" + symtoms);
            //alert(""covidtest:"" + covidtest);
            //alert(""contactwithcovid:"" + contactwithcovid);
        }
        ...
        function AddLog(Question,) {
            var sData = {
                ...
                Answer: Answer,
            ");
                WriteLiteral(@"    DataVariableName: DataVariableName,
            ...
            $.ajax({
                type: ""POST"",
                url: '/Home/AddChatLog',
                data: { jobj: JSON.stringify(sData) },
                success: function (reponse) {
                    var data = JSON.parse(reponse);
                    if (data.Result == 1 || data.Result == 2) {
                        ShowMessage('2', data.Msg);
                    }
                    else
